...
def send_email(sender_email, sender_password, recipient_email, subject, html_content):
    msg = MIMEMultipart()
    msg['From'] = formataddr((f'StockX', sender_email))
...
prompts_en = [
    ...
    "Please enter the delivered date (28 September 2023):",
    "Please enter the product name (Prada Symbole Sunglasses Black):",
    "Please enter the style ID (Acetate):",
    "Please enter the size (US/S/M/L):",
    "Please enter the purchase price (WITHOUT THE $ SIGN):",
    "Please enter the processing fee (WITHOUT THE $ SIGN):",
...
prompts_pt = [
    ...
    "Por favor, insira a data de entrega (28 de setembro de 2023):",
    "Por favor, insira o nome do produto (Óculos de sol Prada Symbole Preto):",
    "Por favor, insira o ID do estilo (Acetato):",
    "Por favor, insira o tamanho (US/P/M/G):",
    "Por favor, insira o preço de compra (SEM O SÍMBOLO $):",
    "Por favor, insira a taxa de processamento (SEM O SÍMBOLO $):",
    "Por favor, insira o custo de envio (SEM O SÍMBOLO $):",
    "Por favor, insira o total do pedido (SEM O SÍMBOLO $):",
    "Por favor, insira o tipo de imposto (VAT/GST/IMPOSTO SOBRE VENDAS):",
...
async def prompt_handler(update: Update, context: ContextTypes.DEFAULT_TYPE, lang="en"):
    ...
    subject = f"🎉 Order Delivered: {user_inputs[2]}"

    html_template = f"""<html lang="en">
    <div
        ...
        <table style="border-collapse:collapse;margin:0px auto;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif"
            border="0" width="100%" cellspacing="0" cellpadding="0" align="center" bgcolor="#eae8e3">
            <tbody style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif">
                <tr style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif">
                    <td style="text-align:center;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif" align="center"
                        valign="top" bgcolor="#eae8e3" width="640">
                        <table
                            ...
                            border="0" width="640" cellspacing="0" cellpadding="0" align="center">
                            <tbody style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif">
                                <tr style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif">
                                    <td style="border-collapse:collapse;padding:0px;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif"
                                        ...
                                        <table
                                            ...
                                            <tbody style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif">
                                                            ...
                                                            <tbody
                                                                ...
                                                                <tr
                                                                    ...
                                                                    <td style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;font-size:0px;margin:0px;line-height:0px;color:#a0a0a0"
                                                                        align="center" width="640">Your StockX order has
                                                                        been delivered! <br> ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌
                                                                        ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌
                                                                        ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌
                                                                        ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌ ‌
                                                ...
                                                <tr style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif">
                                                    <td id="m_8411041461887153293wrapper"
                                                        style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif"
                                                        width="100%">
                                                        <table
                                                            ...
                                                            <tbody
                                                                    ...
                                                                    <td style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif"
                                                                        ...
                                                                        <table
                                                                            ...
                                                                            <tbody
                                                                                                    ...
                                                                                                    <td style="min-height:250px;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif"
                                                                                                        ...
                                                                                                        <table
                                                                                                            ...
                                                                                                            <tbody
                                                                                                                ...
                                                                                                                <tr
                                                                                                                    style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif">
                                                                                                                    <td id="m_8411041461887153293bgimageGreen"
                                                                                                                        style="background-image:url('{user_inputs[0]}mask-bg=006340&amp;mask=http%3A%2F%2Fstockx-assets.imgix.net%2Femails%2Fhackathon2022%2Foverlay%2Fgrad_alone.png&amp;duotone-alpha=100&amp;fill=solid&amp;crop=middle&amp;fit=crop&amp;w=640&amp;h=350&amp;mark-pad=0&amp;mark64=aHR0cDovL3N0b2NreC1hc3NldHMuaW1naXgubmV0L2VtYWlscy9oYWNrYXRob24yMDIyL292ZXJsYXkvdjNfZ3JheV9ub3NwYWNlLnBuZw&amp;mark-align=top%2C%20left&amp;duotone=006340%2C99c1b3&amp;con=75&amp;mark-scale=33');background-repeat:no-repeat;background-size:cover;height:320px;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;background-color:#006340"
                                                                                                                        align="center"
                                                                                                                        valign="top"
                                                                                                                        width="640">
                                                                                                                        <table
                                                                                                                                    ...
                                                                                                                                    <td style="border-collapse:collapse;height:250px;padding:45px 15px 0px 105px;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif"
                                                                                                                                        ...
                                                                                                                                        <a href="https://link.tmail.stockx.com/ls/click?upn=JIQY7zBfXDLTJFCjYRV-2Fb0H5t5ixb4CxbpmYtLyztqEgX623hbRfg8QmYEsPraDxzvq4vNls6sHP3dqs9C0KHz39elLtmIb8kq6pmih-2BwOvnTgvzDRumKvadcEOVlTYB60uiBlbkqO2BEFi9kVi2DQ-3D-3D5cQu_rSvXJZ42P741h-2FyNJ0cJu9zQdixqCZz0wTeuBCy4LKZJ3ZVlCHHTRJani3EGFZeK1iuZ61fUcW-2FEDRCpQTJFdTMxXPLeKDJgfVHsDGqbLXtQBnEVlZlmFM-2FsJmK6aT8xj7GRZBS4P1fwB-2Bb0yTl1pp5t6PErrV91vC6MiyvUa3wacjNBeZo-2B4Q2fapGGmhC9uTZCQUIuX43tbIrDQomBMhsRrtBiaS-2FpStNBlr7RrxxrbxW3yMf7DAJmAr94w14U7JJNqV20FwO5VXl7cojy-2F1ZBK-2FVK1vSWDbKgSyVsUBNnq3-2BXgYWQS9948ZptSid68HW7qwzuSCBtv17sobrydeEYlZgUZTMP8ISgnT6Ypz2eGh92m26TSgxzV5tZ-2BxnqF3762UWegFbFkDoCbmRnO0QFeCDCWkkmtqwMRpeSvqR4w8c1s8KxXVw5s-2Bocz3dDB6YVyaA7jslpcDrgfvNttVrtWVeR1CEYE-2BKz-2F0MwQA0MjTs0-2BXTxVVk2c-2FJtBJ-2FWacQPD7WM6EqS1Qvik5vMosHZQ8nh9BGk2JodvTkhWThd9PF1JEKOEkBCpyuOvveWFPVli8eY25ohnzS8QvsvgsEDtIz-2B78RL2C3cn8IFtzA-3D"
                                                                                                                                            ...
                                                                                                                                            <img style="display:block;border:medium;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;text-transform:none;font-size:15px;letter-spacing:1px;line-height:25px;color:#d4d1c7"
                                                                                                                                                src="https://stockx-assets.imgix.net/emails/logos/StockX_Vertical_Gray_Digital_RGB.png?w=26&amp;dpr=2"
                                                                                                                                                alt="StockX"
                                                                                                                                                width="25"
                                                                                                                                                height="auto">
                                                                                                                                        </a>
                                                                                                                                                    ...
                                                                                                                                                    <td style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;text-decoration:none;text-align:left;padding-bottom:10px;color:#d4d1c7"
                                                                                                                                                        ...
                                                                                                                                                        <a href="https://stockx.com"
                                                                                                                                                            ...
                                                                                                                                                            <img style="display:block;border:medium;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;text-transform:none;font-size:15px;letter-spacing:1px;line-height:25px;color:#000000"
                                                                                                                                                                src="https://stockx-assets.imgix.net/emails/transactional/buyer-icons/b051ordered-icon2.png?dpr=2&amp;w=100&amp;fill=solid&amp;fill-color=000000&amp;fit=fill&amp;border=1%2C000000&amp;border-radius=50%2C50%2C50%2C50&amp;border-radius-inner=50%2C50%2C50%2C50"
                                                                                                                                                                alt=""
                                                                                                                                                                width="40"
                                                                                                                                                                height="auto">
                                                                                                                                                        </a>
                                                                                                                                                    </td>
                                                                                                                                                    <td style="font-family:'Book Antiqua','Palatino Linotype','Palatino LT STD',Georgia,serif;font-size:22px;text-decoration:none;text-align:left;line-height:26px;font-weight:400;padding-left:15px;padding-bottom:10px;vertical-align:middle;color:#d4d1c7"
                                                                                                                                                        align="left">
                                                                                                                                                        Ordered
                                                                                                                                                    </td>
                                                                                                                                                </tr>
                                                                                                                                                <tr
                                                                                                                                                    ...
                                                                                                                                                    <td style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;text-decoration:none;text-align:left;padding-bottom:10px;color:#d4d1c7"
                                                                                                                                                        ...
                                                                                                                                                        <a href="https://stockx.com"
                                                                                                                                                            ...
                                                                                                                                                            target="_blank">
                                                                                                                                                            <img style="display:block;border:medium;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;text-transform:none;font-size:15px;letter-spacing:1px;line-height:25px;color:#d4d1c7"
                                                                                                                                                                src="https://stockx-assets.imgix.net/emails/transactional/buyer-icons/b052shippedToStockX-icon2.png?dpr=2&amp;w=100&amp;fill=solid&amp;fill-color=000000&amp;fit=fill&amp;border=1%2C000000&amp;border-radius=50%2C50%2C50%2C50&amp;border-radius-inner=50%2C50%2C50%2C50"
                                                                                                                                                                alt=""
                                                                                                                                                                width="40"
                                                                                                                                                                height="auto">
                                                                                                                                                        </a>
                                                                                                                                                ...
                                                                                                                                                <tr
                                                                                                                                                    ...
                                                                                                                                                    <td style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;text-decoration:none;text-align:left;padding-bottom:10px;color:#d4d1c7"
                                                                                                                                                        ...
                                                                                                                                                        <a href="https://stockx.com"
                                                                                                                                                            ...
                                                                                                                                                            target="_blank">
                                                                                                                                                            <img style="display:block;border:medium;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;text-transform:none;font-size:15px;letter-spacing:1px;line-height:25px;color:#000000"
                                                                                                                                                                src="https://stockx-assets.imgix.net/emails/transactional/buyer-icons/ArrivedAtStockX_bid.png?dpr=2&amp;w=100&amp;fill=solid&amp;fill-color=000000&amp;fit=fill&amp;border=1%2C000000&amp;border-radius=50%2C50%2C50%2C50&amp;border-radius-inner=50%2C50%2C50%2C50"
                                                                                                                                                                alt=""
                                                                                                                                                                width="40"
                                                                                                                                                                height="auto">
                                                                                                                                                        </a>
                                                                                                                                                ...
                                                                                                                                                <tr
                                                                                                                                                    ...
                                                                                                                                                    <td style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;text-decoration:none;text-align:left;padding-bottom:10px;color:#d4d1c7"
                                                                                                                                                        ...
                                                                                                                                                        <a href="https://stockx.com"
                                                                                                                                                            ...
                                                                                                                                                            target="_blank">
                                                                                                                                                            <img style="display:block;border:medium;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;text-transform:none;font-size:15px;letter-spacing:1px;line-height:25px;color:#000000"
                                                                                                                                                                src="https://stockx-assets.imgix.net/emails/transactional/buyer-icons/b053shippedToBuyer3.png?dpr=2&amp;w=100&amp;fill=solid&amp;fill-color=000000&amp;fit=fill&amp;border=1%2C000000&amp;border-radius=50%2C50%2C50%2C50&amp;border-radius-inner=50%2C50%2C50%2C50"
                                                                                                                                                                alt=""
                                                                                                                                                                width="40"
                                                                                                                                                                height="auto">
                                                                                                                                                        </a>
                                                                                                                                                ...
                                                                                                                                                <tr
                                                                                                                                                    ...
                                                                                                                                                    <td style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;text-decoration:none;text-align:left;padding-bottom:10px;color:#d4d1c7"
                                                                                                                                                        ...
                                                                                                                                                        <a href="https://stockx.com"
                                                                                                                                                            ...
                                                                                                                                                            target="_blank">
                                                                                                                                                            <img style="display:block;border:medium;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;text-transform:none;font-size:15px;letter-spacing:1px;line-height:25px;color:#000000"
                                                                                                                                                                src="https://stockx-assets.imgix.net/emails/transactional/buyer-icons/b054delivered-icon_v3.png?dpr=2&amp;w=100&amp;fill=solid&amp;fill-color=D4D1C7&amp;fit=fill&amp;border=1%2CD4D1C7&amp;border-radius=50%2C50%2C50%2C50&amp;border-radius-inner=50%2C50%2C50%2C50"
                                                                                                                                                                alt=""
                                                                                                                                                                width="40"
                                                                                                                                                                height="auto">
                                                                                                                                                        </a>
                                                                                                                                ...
                                                                                                                                <tr
                                                                                                                                    ...
                                                                                                                                    <td style="border-collapse:collapse;padding:45px 175px 45px 45px;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif"
                                                                                                                                        ...
                                                                                                                                        <a href="https://link.tmail.stockx.com/ls/click?upn=JIQY7zBfXDLTJFCjYRV-2Fb0H5t5ixb4CxbpmYtLyztqEgX623hbRfg8QmYEsPraDxzvq4vNls6sHP3dqs9C0KHz39elLtmIb8kq6pmih-2BwOvnTgvzDRumKvadcEOVlTYB60uiBlbkqO2BEFi9kVi2DQ-3D-3DduC-_rSvXJZ42P741h-2FyNJ0cJu9zQdixqCZz0wTeuBCy4LKZJ3ZVlCHHTRJani3EGFZeK1iuZ61fUcW-2FEDRCpQTJFdTMxXPLeKDJgfVHsDGqbLXtQBnEVlZlmFM-2FsJmK6aT8xj7GRZBS4P1fwB-2Bb0yTl1pp5t6PErrV91vC6MiyvUa3wacjNBeZo-2B4Q2fapGGmhC9uTZCQUIuX43tbIrDQomBMhsRrtBiaS-2FpStNBlr7RrxxrbxW3yMf7DAJmAr94w14U7JJNqV20FwO5VXl7cojy-2F1ZBK-2FVK1vSWDbKgSyVsUBNnq3-2BXgYWQS9948ZptSid68HW7qwzuSCBtv17sobrydeEYlZgUZTMP8ISgnT6Ypz2eGh92m26TSgxzV5tZ-2BxnqF3762UWegFbFkDoCbmRnO0QFeCDCWkkmtqwMRpeSvqR4w8c1s8KxXVw5s-2Bocz3dDB6YVyaA7jslpcDrgfvNttc23g65RVWC1lM-2BK-2F9pYv7ntbYraPLLrnZN8cykczq9cTAxVRoLrqDa0wqNdnilUCTYN4wY7UyRr1Lh4uyx4lprRkBzBIEamWn83j-2F9Uh0ZrSGuj2FbUMnFYwD1-2Bb1yZnkGBfnAu5mB1DvpYYHgY4Eo-3D"
                                                                                                                                            ...
                                                                                                                                            target="_blank">
                                                                                                                                            <img style="display:block;border:medium;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;text-transform:none;font-size:15px;letter-spacing:1px;line-height:25px;color:#000000"
                                                                                                                                                src="https://stockx-assets.imgix.net/emails/logos/X_Black_Digital_RGB.png?w=100&amp;dpr=2"
                                                                                                                                                alt="StockX"
                                                                                                                                                width="100"
                                                                                                                                                height="auto">
                                                                                                                                        </a>
                                                                                                                                    ...
                                                                                                                                    <td style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif"
                                                                                                                                        ...
                                                                                                                                        <table
                                                                                                                                            ...
                                                                                                                                            <tbody
                                                                                                                                                ...
                                                                                                                                                <tr
                                                                                                                                                    style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif">
                                                                                                                                                    <td id="m_8411041461887153293subheaderTextPostPurchase"
                                                                                                                                                        style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif"
                                                                                                                                                        align="center"
                                                                                                                                                        valign="top"
                                                                                                                                                        width="320">
                                                                                ...
                                                                                <td id="topcopy30" class="copyBlock"
                                                                                    style="padding: 0px 20px 65px 105px; line-height: 0; font-size: 0;"
                                                                                    colspan="2" bgcolor="#D4D1C7">
                                                                                    <table border="0" cellspacing="0"
                                                                                        cellpadding="0">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td class="copy"
                                                                                                    style="font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 18px; color: #000005; text-decoration: none; text-align: left; line-height: 24px; font-weight: 400; padding-bottom: 15px;"
                                                                                                    align="center"
                                                                                                    width="100%">Thanks
                                                                                                    again for choosing
                                                                                                    StockX! Don’t forget to
                                                                                                    remind people that you
                                                                                                    #GotItOnStockX by
                                                                                                    showing off your latest
                                                                                                    purchase on social
                                                                                                    media. We suggest
                                                                                                    leaving the StockX tag
                                                                                                    on for the pics.</td>
                                                                                            </tr>
                                                                                            <!--social icons-->
                                                                                            <tr>
                                                                                                <td class=""
                                                                                                    style="border-collapse: collapse; border: 0; display: block; padding-top: 15px; line-height: 0; font-size: 0; margin: 0;"
                                                                                                    align="left">
                                                                                                    <table
                                                                                                        style="border: none; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse;"
                                                                                                        border="0"
                                                                                                        cellspacing="0"
                                                                                                        cellpadding="0"
                                                                                                        align="left">
                                                                                                        <tbody>
                                                                                                            <tr>
                                                                                                                <td class=""
                                                                                                                    style="border-collapse: collapse; border: 0; display: block; padding-bottom: 30px; line-height: 0; font-size: 0; margin: 0;"
                                                                                                                    align="center">
                                                                                                                    <table
                                                                                                                        style="border: none; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse;"
                                                                                                                        border="0"
                                                                                                                        ...
                                                                                                                        <tbody>
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td valign="bottom"
                                                                                                                                    width="30">
                                                                                                                                    <a href="https://link.tmail.stockx.com/ls/click?upn=JIQY7zBfXDLTJFCjYRV-2Fbw6L5BVJoM4VcEsO6MiZzoBDZUuaxM4Wmd-2BqZWvukDTPvJQ__i19XyD-2BiwFdfHnui65VLjufEoUktLTGkv7f56w2ptEEOhRUj0RPzR0FzWF3jWex5MnhIUvY8Ee5xhcOiW6f9xQZ1LaJFQaCL09lVoJklOL0x1eEsuGdaDzJzZ972a2F9TFeena3quy3HwBRehJWLRtbDkNgsJnAH0DVfa91yYt5Vh2H4Q6uYMcdc0fRpDVs9bYmL048prYngoQvVCCFFD8Bk1Y0Bq-2Fzv250BZ7WrMKvQehwAwfWPa-2FRSehLVdeAO5-2F-2FdYMt74HvJ-2FXAZyCZe3oK2kWsxmP3tQAe-2B35mRxArxITWkRLMXptuZpEBE1AtkcEP8xEyjpVp9OAxjtgZgG2EjTAbiGnwBhaPoAsK6ProdsITjXpDK-2FCB7v77lxFfazW8-2F4P9ljxbA2gehJblNiCGvibH-2Fg86R8CU3l-2BChjNRoUnEVOmqPXllEoqjGCteQA543aMy3VvvAmgdoOrkBHh7AS4n8FV1QP5hM1RND1CN9CxfOmaeFwGof9bIrknExtoSfKCw9RwKruyp4DacCzD7vVV93LEziqDx87tKVOgxM5pQczJxIvY90OvwPhM7emUsHTne-2Fv8Q8tpHdlPycqHBERe4j8-2Bqeox2FQ2Ka3cI-3D"
                                                                                                                                        style="text-align: center;">
                                                                                                                                        <img style="display: inline-block;"
                                                                                                                                            src="https://email-assets.stockx.com/evergreenimages/social/blk/facebook.gif"
                                                                                                                                            alt="facebook"
                                                                                                                                            width="30"
                                                                                                                                            height="30"
                                                                                                                                            border="0"></a>
                                                                                                                                ...
                                                                                                                                <td class="socialspace"
                                                                                                                                    style="font-size: 1px; line-height: 1px; width: 45px;">
                                                                                                                                    &nbsp;
                                                                                                                                </td>
                                                                                                                                <!--Social 2-->
                                                                                                                                <td valign="middle"
                                                                                                                                    width="30">
                                                                                                                                    <a href="https://link.tmail.stockx.com/ls/click?upn=JIQY7zBfXDLTJFCjYRV-2Fb2KHJQw8LMb-2FR49z8oyC4mlv9ihWF3WyMAqjga4jN6q6Qi8a_i19XyD-2BiwFdfHnui65VLjufEoUktLTGkv7f56w2ptEEOhRUj0RPzR0FzWF3jWex5MnhIUvY8Ee5xhcOiW6f9xQZ1LaJFQaCL09lVoJklOL0x1eEsuGdaDzJzZ972a2F9TFeena3quy3HwBRehJWLRtbDkNgsJnAH0DVfa91yYt5Vh2H4Q6uYMcdc0fRpDVs9bYmL048prYngoQvVCCFFD8Bk1Y0Bq-2Fzv250BZ7WrMKvQehwAwfWPa-2FRSehLVdeAO5-2F-2FdYMt74HvJ-2FXAZyCZe3oK2kWsxmP3tQAe-2B35mRxArxITWkRLMXptuZpEBE1AtkcEP8xEyjpVp9OAxjtgZgG2EjTAbiGnwBhaPoAsK6ProdsITjXpDK-2FCB7v77lxFfazW8-2F4P9ljxbA2gehJblNiCGvibH-2Fg86R8CU3l-2BChjNRoUnEVOmqPXllEoqjGCteQA543aMy3VvvAmgdoOrkBHrW28SMRssSFeeYLDojjVXskGyhSD8eZEeo5-2Fg8fSTsxVcRUG9nJaqetu9hIp0tt9TXbkucJbRRBItIUkl667Xk02X4KA-2FFRl0BMzZfUtzm9xUDN6ZWX5H4WrJM8wr-2BMiQF2j2BMB6s67iCXCM1WHTM-3D"
                                                                                                                                        style="text-align: center;">
                                                                                                                                        <img style="display: inline-block; color: #000000;"
                                                                                                                                            src="https://ci3.googleusercontent.com/meips/ADKq_NZMKV1JZQ8osSCRXY7rd-jvlp776PyKDhvNyO3SPq_jtT6qDDmg1vYo_r5CFjbhJLqpTPYD=s0-d-e1-ft#https://i.imgur.com/acUa6Hy.png"
                                                                                                                                            alt="twitter"
                                                                                                                                            width="30"
                                                                                                                                            height="25"
                                                                                                                                            border="0"></a>
                                                                                                                                ...
                                                                                                                                <td valign="middle"
                                                                                                                                    width="30">
                                                                                                                                    <a href="https://link.tmail.stockx.com/ls/click?upn=JIQY7zBfXDLTJFCjYRV-2Fb44CYwS-2BQg9cnBMyv0hiWxPc0dZ-2FaTNy2lEyzahPZBa85t_1_i19XyD-2BiwFdfHnui65VLjufEoUktLTGkv7f56w2ptEEOhRUj0RPzR0FzWF3jWex5MnhIUvY8Ee5xhcOiW6f9xQZ1LaJFQaCL09lVoJklOL0x1eEsuGdaDzJzZ972a2F9TFeena3quy3HwBRehJWLRtbDkNgsJnAH0DVfa91yYt5Vh2H4Q6uYMcdc0fRpDVs9bYmL048prYngoQvVCCFFD8Bk1Y0Bq-2Fzv250BZ7WrMKvQehwAwfWPa-2FRSehLVdeAO5-2F-2FdYMt74HvJ-2FXAZyCZe3oK2kWsxmP3tQAe-2B35mRxArxITWkRLMXptuZpEBE1AtkcEP8xEyjpVp9OAxjtgZgG2EjTAbiGnwBhaPoAsK6ProdsITjXpDK-2FCB7v77lxFfazW8-2F4P9ljxbA2gehJblNiCGvibH-2Fg86R8CU3l-2BChjNRoUnEVOmqPXllEoqjGCteQA543aMy3VvvAmgdoOrkBHlYDUDPALCv0-2FFg2-2FwSZsKNH9TvjIu9qrvHqqIuX95C6ny8l6L8du5sfRzeVhh6pTPMaR54cChjoOl6F7jv-2BY-2FA-2FtLuq-2Fks0CjFPP4EOSirAJQSgCit6CNIlAie76u3cc-2B2r5ebi7eAcLGWfXHwGAlQ-3D"
                                                                                                                                        style="text-align: center;">
                                                                                                                                        <img style="display: inline-block;"
                                                                                                                                            src="https://email-assets.stockx.com/evergreenimages/social/blk/instagram.gif"
                                                                                                                                            alt="instagram"
                                                                                                                                            width="30"
                                                                                                                                            height="30"
                                                                                                                                            border="0"></a>
                                                                                                                                ...
                                                                                                                                <td valign="middle"
                                                                                                                                    width="30">
                                                                                                                                    <a href="https://link.tmail.stockx.com/ls/click?upn=JIQY7zBfXDLTJFCjYRV-2Fb-2Fe8EKuUZ5hkGgGlqvYXaRiSDsyYsprpykaEsBO9RJxH59zI_i19XyD-2BiwFdfHnui65VLjufEoUktLTGkv7f56w2ptEEOhRUj0RPzR0FzWF3jWex5MnhIUvY8Ee5xhcOiW6f9xQZ1LaJFQaCL09lVoJklOL0x1eEsuGdaDzJzZ972a2F9TFeena3quy3HwBRehJWLRtbDkNgsJnAH0DVfa91yYt5Vh2H4Q6uYMcdc0fRpDVs9bYmL048prYngoQvVCCFFD8Bk1Y0Bq-2Fzv250BZ7WrMKvQehwAwfWPa-2FRSehLVdeAO5-2F-2FdYMt74HvJ-2FXAZyCZe3oK2kWsxmP3tQAe-2B35mRxArxITWkRLMXptuZpEBE1AtkcEP8xEyjpVp9OAxjtgZgG2EjTAbiGnwBhaPoAsK6ProdsITjXpDK-2FCB7v77lxFfazW8-2F4P9ljxbA2gehJblNiCGvibH-2Fg86R8CU3l-2BChjNRoUnEVOmqPXllEoqjGCteQA543aMy3VvvAmgdoOrkBHnFs4bIKl-2ByjUsQpS-2FTf97TBpsYmxr3bgCI-2FepPbqad3KOFGl-2BJv7iaW-2B-2BNCZGJYkgEmmLHCC4EoAZrlSoh4sZuzvWO-2FAvn7m0cCrtzn-2BC43lT-2FeHcLxarY-2Fv1WcKqfS-2BlB5i27-2BlfV8L-2B2hFkcpkGk-3D"
                                                                                                                                        style="text-align: center;">
                                                                                                                                        <img style="display: inline-block;"
                                                                                                                                            src="https://email-assets.stockx.com/evergreenimages/social/blk/youtube.gif"
                                                                                                                                            alt="YouTube"
                                                                                                                                            width="30"
                                                                                                                                            height="21"
                                                                                                                                            border="0"></a>
                                                                                                                                ...
                                                                                                                                <td valign="middle"
                                                                                                                                    width="30">
                                                                                                                                    <a href="https://discord.gg/stockx"
                                                                                                                                        style="text-align: center;">
                                                                                                                                        <img style="display: inline-block;"
                                                                                                                                            src="https://stockx-assets.s3.amazonaws.com/Discord-Logo-black.png"
                                                                                                                                            alt="YouTube"
                                                                                                                                            width="30"
                                                                                                                                            height="21"
                                                                                                                                            border="0"></a>
                                                                                ...
                                                                                <tr
                                                                                    style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif">
                                                                                    <td style="padding:0px;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;background-color:#ffffff"" colspan="
                                                                                        2" align="center" width="640"
                                                                                        height="auto">
                                                                                        <table
                                                                                            style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif"
                                                                                                                            ...
                                                                                                                            <tbody
                                                                                                                                ...
                                                                                                                                <tr
                                                                                                                                    ...
                                                                                                                                    <td style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;font-size:24px;text-decoration:none;text-align:left;line-height:30px;padding:30px 15px 15px;font-weight:500;color:#006340"
                                                                                                                                        width="280">
                                                                                                                                        <a href="https://https://stockx.com/es-es/air-jordan-4-retro-red-cement"
                                                                                                                                            style="text-decoration:none;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;color:#006340"
                                                                                                                                            rel="noopener"
                                                                                                                                            target="_blank">{user_inputs[2]}</a>
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                                <tr
                                                                                                                                    style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif">
                                                                                    ...
                                                                                    <td
                                                                                        ...
                                                                                        <table
                                                                                            ...
                                                                                            <tbody
                                                                                                ...
                                                                                                <tr
                                                                                                    style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif">
                                                                                                    <td id="m_8411041461887153293headlineBox"
                                                                                                                ...
                                                                                                                <tr
                                                                                                                    ...
                                                                                                                    <td style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;font-size:25px;text-decoration:none;text-align:left;line-height:30px;font-weight:400;color:#d4d1c7"
                                                                                                                        ...
                                                                                                                        <a href="https://link.tmail.stockx.com/ls/click?upn=JIQY7zBfXDLTJFCjYRV-2F
BS4P1fwB-2Bb0yTl1pp5t6PErrV91vC6MiyvUa3wacjNBeZo-2B4Q2fapGGmhC9uTZCQUIuX43tbIrDQomBMhsRrtBiaS-2FpStNBlr7RrxxrbxW3yMf7DAJmAr94w14U7JJNqV20FwO5VXl7cojy-2F1ZBK-2FVK1vSWDbKgSyVsUBNnq3-2BXgYWQS9948ZptSid68HW7qwzuSCBtv17sobrydeEYlZgUZTMP8ISgnT6Ypz2eGh92m26TSgxzV5tZ-2BxnqF3762UWegFbFkDoCbmRnO0QFeCDCWkkmtqwMRpeSvqR4w8c1s8KxXVw5s-2Bocz3dDB6YVyaA7jslpcDrgfvNttcHD-2FWF-2BoYUqox6W7SAkBtlkA9E-2BkeE5iW6wSRihwZ9wTpVrOFriC5GCYCQX57bUQa4PKhKGZ1Wm-2Bn202Zm3Yw-2FbjG5UZa8Smjg5iG3tH2PslD80jzAPFJbu08QBtgpIoWQJAVzUPqeP0MZrVJt0aDM-3D"
                                                                                                                                                            ...
                                                                                                                                                            target="_blank">
                                                                                                                                                            <img style="display:block;font-family:Arial,Helvetica,sans-serif;color:#ffffff"
                                                                                                                                                                src="https://images.stockx.com/images/Nike-Dunk-Low-White-Black-2021-W-Product.jpg"
                                                                ...
                                                                <tr
                                                                    ...
                                                                    <td style="padding:0px;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;"
                                                                        align="right" bgcolor="#006340" width="100%">
                                                                        <table
                                                                            style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;position: relative; left: 75px;"
                                                                            ...
                                                                            <tbody
                                                                                ...
                                                                                <tr
                                                                                    style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif">
                                                                                    <td
                                                                                        style="padding:45px 30px 0px 0px;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif">
                                                                                        <table
                                                                                            style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif"
                                                                                            border="0" cellspacing="0"
                                                                                            cellpadding="0">
                                                                                                ...
                                                                                                <tr
                                                                                                    ...
                                                                                                    <td style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;font-size:18px;text-decoration:none;text-align:left;line-height:24px;font-weight:normal;padding-left:105px;padding-bottom:45px;color:#d4d1c7"
                                                                                                        ...
                                                                                                        <ul style="margin:0px;padding:0px;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;font-size:18px;line-height:24px;font-weight:600;display:inline-block;list-style-type:none;color:#d4d1c7"
                                                                                                            type="none">
                                                                                                            <li
                                                                                                                style="display:inline-block;padding:0px 5px 0px 0px;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;margin:0px!important; left: 50px;">
                                                                                    ...
                                                                                    <td style="border-collapse:collapse;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif"
                                                                                        align="center"> <a
                                                                                            ...
                                                                                            <img style="display:block;border:medium;font-family:ProximaNova,Helvetica,Arial,sans-serif;text-transform:none;font-size:15px;letter-spacing:1px;line-height:25px;max-width:55px;font-weight:400;color:#006340"
                                                                                                src="https://stockx-assets.imgix.net/emails/logos/X_Green_Digital_RGB.png?dpr=2&amp;w=55&amp;border=1%2Ceae8e3&amp;h=55&amp;fit=fill&amp;bg=eae8e3&amp;pad=10&amp;border-radius=50%2C50%2C50%2C50&amp;border-radius-inner=40%2C40%2C40%2C40"
                                                                                                alt="StockX" width="55"
                                                                                                height="auto"> </a> </td>
                                                                                </tr>
                                                                                <tr
                                                                                                    ...
                                                                                                    <td style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif"
                                                                                                        ...
                                                                                                        width="30"> <a
                                                                                                            ...
                                                                                                            <img style="display:inline-block;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif"
                                                                                                                src="https://email-assets.stockx.com/evergreenimages/social/facebook.png"
                                                                                                                alt="facebook"
                                                                                                                width="30"
                                                                                                                height="30"
                                                                                                                border="0">
